...
#    "hdmi_out_demo.hdf"
#    "hdmi_out_demo/src"
#    "bootimage/hdmi_out_demo.bif"
#    "bootimage/hdmi_out_demo_debug.bif"
#*****************************************************************************************

# Set the reference directory for source file relative paths (by default the value is script directory path)
set origin_dir "[file normalize "."]"

set demo_project_name "hdmi_out_demo"
set hw_project_name "demo_hw_platform"
set bsp_project_cpu0_name "demo_standalone_cpu0_bsp"
...
puts "HDMA Out Demo hardware project $demo_project_name"

# Check HDF exists
set hdf_file_name ${demo_project_name}.hdf
...
createbsp -name $bsp_project_cpu0_name -hwproject $hw_project_name -proc [get_processor_name $hw_project_name] -os standalone
...
createapp -name $demo_project_name -app {Empty Application} -bsp $bsp_project_cpu0_name -hwproject ${hw_project_name} -proc [get_processor_name $hw_project_name] -os standalone
...
if { $build_config == "release" || $build_config == "all" } {
    ...
    configapp -app $demo_project_name define-compiler-symbols "PROJECT=HDMI_OUT_DEMO_APP"
...
if { $build_config == "debug" || $build_config == "all" } {
    ...
    configapp -app $demo_project_name define-compiler-symbols "PROJECT=HMDI_OUT_DEMO_APP"
    configapp -app $demo_project_name define-compiler-symbols "CPU0"
    configapp -app $demo_project_name linker-misc { -Xlinker --defsym=_STACK_SIZE=0x200000 }
    configapp -app $demo_project_name linker-misc { -Xlinker --defsym=_HEAP_SIZE=0x200000 }
    configapp -app $demo_project_name libraries "m"
