...
# ./work/hdmi_out_demo.xpr Vivado project. The resulting files for the SDK are copied to:
# ../SDK/hdmi_out__demo_top.hdf
#*****************************************************************************************
...
file copy -force "[file normalize "$work_directory/hdmi_out_demo.runs/impl_1/hdmi_out_wrapper.sysdef"]" "$sdk_directory/hdmi_out_demo.hdf"

open_run impl_1

report_utilization -file hdmi_out_demo_util_report.txt

report_timing_summary -delay_type min_max -input_pins -routable_nets -name timing_1 -file hdmi_out_timing_report.txt
