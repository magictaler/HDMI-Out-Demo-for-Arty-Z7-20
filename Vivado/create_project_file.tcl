#*****************************************************************************************
# This script will built the ./work/hdmi_out_demo.xpr Vivado project file from the following
# sources:
#    "tcl/top_level_hdmi_out_demo.tcl"
...
# Create project
create_project hdmi_out_demo -force
...
set obj [get_projects hdmi_out_demo]
set_property "default_lib" "xil_defaultlib" $obj
set_property "ip_cache_permissions" "read write" $obj
set_property "part" $part $obj
set_property "board_part" $brd_part $obj
set_property "ip_output_repo" "hdmi_out_demo.cache/ip" $obj
...
source $origin_dir/tcl/top_level_hdmi_out_demo.tcl
set origin_dir $origin_dir_bak

# Add VHDL top architecture - a few examples below
#add_files -norecurse $origin_dir/sources/hdmi_out.vhd
#set_property file_type {VHDL 2008} [get_files $origin_dir/sources/hdmi_out.vhd]
#add_files -norecurse $origin_dir/ip_repo/auto_pc_0/hdmi_out_auto_pc_0.xci
...
set_property "top" "hdmi_out_wrapper" $obj
...
# at 0.
open_bd_design [file normalize "$work_directory/hdmi_out_demo.srcs/sources_1/bd/hdmi_out/hdmi_out.bd"]
...
puts "INFO: Project created:hdmi_out_demo"
